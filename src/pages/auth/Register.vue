...
import { registerUserService } from "@/utils/services/user";
...
<template>
  <div class="flex items-center justify-center flex-col gap-6">
    ...
    <p class="text-sm text-gray-500 dark:text-gray-300">
      Já possui uma conta?
      <router-link to="/auth/login" class="text-header font-medium hover:underline cursor-pointer dark:text-sky-300">
        Entre agora
      </router-link>
    </p>
  </div>
